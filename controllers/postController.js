import { create_post_retreival_query, create_post_upload_query } from "../services/postService.js";
...
export const create_post = async (req, res) => {
    try {
        const [query, values] = await create_post_upload_query(req);
        await dbService.instance.execute_dynamic_query(query, values);
        res.status(200).json({ success: true, message: 'Post created successfully!.', data: posts });
    } catch (error) {
